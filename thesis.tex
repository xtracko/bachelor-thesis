...
EACirc is based on the principles of evolutionary algorithms. Generally, these algorithm search a locally optimal solution by iteration of three phases: 

\todo{how eacirc processes data (explain the iteration)}

\todo{what are circuit backends}
