...
%\usepackage[plainpages=false, pdfpagelabels, unicode]{hyperref}  %pc version
\usepackage[plainpages=false, pdfpagelabels, unicode, hidelinks]{hyperref} %print version
...
\begin{figure}[h]
	...
	\addplot
	coordinates {
		(32, 0.37776)(64, 0.23408)(96, 0.23888)(128, 0.271264)(160, 0.338464)(192, 0.326208)(224, 0.26112)(256, 0.282016)(288, 0.273024)(320, 0.303232)(352, 0.29648)(384, 0.313536)(416, 0.378208)(448, 0.322496)(480, 0.225312)(512, 0.223872)(544, 0.286656)(576, 0.375552)(608, 0.265088)(640, 0.307424)(672, 0.32992)(704, 0.305024)(736, 0.246144)(768, 0.277216)(800, 0.256096)(832, 0.255712)(864, 0.274752)(896, 0.26752)(928, 0.3512)(960, 0.260064)(992, 0.344224)(1024, 0.311936)
	};
...
\begin{figure}[h]
	...
	y label style={at={(axis description cs:-0.1,.2)},anchor=west},	
	xlabel={Vector count [1]},
	ylabel={Time [$ms$]},
	log ticks with fixed point,
	xmin=1000, xmax=256000,
	ymin=0, ymax=100000,
	ymajorgrids=true,
	grid style=dashed,
	...
	\addplot coordinates {
	(1000, 10.041)(2000, 9.317)(4000, 15.877)(8000, 23.575)(16000, 42.094)(32000, 60.696)(64000, 123.308)(128000, 223.331)(256000, 485.104)
	};
	\addplot coordinates {
	(1000, 364.408)(2000, 665.742)(4000, 1426.367)(8000, 2900.807)(16000, 6052.413)(32000, 10535.213)(64000, 22244.065)(128000, 42228.197)(256000, 88626.516)
	};
	\legend{GPU, CPU}
...
The next figure gives a more detailed view at the data shown in the previous graph~\ref{fig:cpu_vs_gpu_performance}. The figure~\ref{fig:speedup} shows the ratio of CPU and GPU performances according to the number of processed vectors, i.e. how many times the GPU circuit is faster than its CPU version, i.e the speed-up of the accelerated circuit.
...
\begin{figure}[h]
	...
	width=0.9\textwidth,height=6cm,
	xlabel={Vector count [$1$]},
	ylabel={$\frac{CPU_time}{GPU_time}$ [$1$]},
	log ticks with fixed point,
	xmin=0, xmax=256000,
	ymajorgrids=true,
	grid style=dashed,
	...
	\end{axis}
	\end{tikzpicture}
	\caption{Overall speed-up}
	\label{fig:speedup}
\end{figure}

According to the figure~\ref{fig:speedup}, at the beginning a sharp increase in speed-up can be seen. This is caused by the overhead around the GPU computation such as copying the data to/from the device. The execution of the circuit is most effective if it processes at least 16,000 input vectors\footnote{The default setting of the size of the input vector is 16 bytes.} per one evaluation of the circuit.
